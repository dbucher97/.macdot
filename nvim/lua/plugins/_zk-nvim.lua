return function()
  ...
  commands.add(
    "ZkDailies",
    make_edit_fn({ hrefs = { "daily" } }, { title = "Zk Dailies" })
  )
  commands.add(
    "ZkFleetings",
    make_edit_fn({ hrefs = { "fleeting" } }, { title = "Zk Fleetings" })
  )
  commands.add(
    "ZkLiteratures",
    make_edit_fn({ hrefs = { "literature" } }, { title = "Zk Literatures" })
  )
  commands.add(
    "ZkPermanent",
    make_edit_fn(
      { excludeHrefs = { "daily", "fleeting", "literature" } },
      { title = "Zk Permanent Notes" }
    )
  )
